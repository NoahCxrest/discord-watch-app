...
import { z } from "zod";
import { getAllApplications, searchApplications, getPaginatedApplications } from "~/server/db/applications";
import type { ApplicationListItem, ApplicationSelect } from "~/types/application";
...
export const applicationsRouter = createTRPCRouter({
  ...
  getPaginated: publicProcedure.input(z.object({
